...
function displayGenome(genome)
	displayForm = forms.newform(500, 500, "Genome")
	netPicture = forms.pictureBox(displayForm, 5, 250,470, 200)
...
function loadPool()
	filename = forms.openfile("DP1.State.pool","D:/NEAT-Galaga/Galaga-NEAT/network/pool") 
	--local filename = forms.gettext(saveLoadFile)
...
writeFile("D:/NEAT-Galaga/Galaga-NEAT/network/temp-pool/temp.pool")
...
displayNetworkButton = forms.button(form, "Display Network", displayNetwork, 305, 102)

saveLoadFile = forms.textbox(form, "D:/NEAT-Galaga/Galaga-NEAT/network/pool/DP1.State.pool", 170, 25, nil, 5, 148)
